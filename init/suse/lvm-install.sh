...
zypper --non-interactive install rpm zypper openSUSE-release kernel-default makedev sudo nano less dosfstools grub2 grub2-x86_64-efi shim efibootmgr firewalld openssl lvm2
