...
zypper --root /mnt --gpg-auto-import-keys refresh ; sleep 3
...
zypper --non-interactive install ca-certificates-cacert ca-certificates-mozilla ca-certificates
zypper --gpg-auto-import-keys refresh
update-ca-certificates
zypper --non-interactive install rpm zypper openSUSE-release kernel-default makedev sudo nano less dosfstools grub2 grub2-x86_64-efi shim efibootmgr firewalld openssl kernel-default-devel
