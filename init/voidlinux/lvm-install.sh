...
pkg_list="linux-lts linux-lts-headers libgcc ethtool base-voidstrap bash grub grub-x86_64-efi cryptsetup lvm2 openssh sudo efibootmgr"
if [ ! "" = "$(which xbps-install.static)" ] ; then
...
yes | xbps-install -Sy void-repo-nonfree void-repo-multilib void-repo-multilib-nonfree python nano
